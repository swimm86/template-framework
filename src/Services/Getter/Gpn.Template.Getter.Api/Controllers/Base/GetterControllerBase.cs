// ----------------------------------------------------------------------------------------------
// <copyright file="GetterControllerBase.cs" company="ООО Газпромнефть - Цифровые решения">
...
public abstract class GetterControllerBase(ILogger logger) : ControllerBase(logger)
{
}
